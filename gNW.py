...
if __name__ == '__main__' :
    ...
    parser.add_argument('-ids', type=int, default = 10, help="Identity score (positive INT)")
    parser.add_argument('-mms', type=int, default = -10, help="Mismatch score (non-positive INT)")
    parser.add_argument('-alpha', type=int, default = -1, help="alpha (non-negative INT)")
    parser.add_argument('-beta', type=int, default = 3, help="beta (non-negative INT)")
